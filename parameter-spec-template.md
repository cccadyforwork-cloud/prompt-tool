...
```text
Image 4 Size/Capacity: size/capacity reference infographic. Top layout must keep the fixed parameter style: large title “Size Reference”. Directly below it, render a clearly visible subtitle text exactly as: “【当前SKU/主规格】”. Under the subtitle, use a dark rounded spec capsule showing packaging quantity only: 【包装数量】. Do not put packaging quantity in the title or subtitle. Do not include product name or spec name inside the capsule. Large product is the focus in the main area. Show capacity as a clear main text callout paired with a small cup/container icon: 【容量/适用杯量】. Use clean arrows/dashed guides only for verified dimensions: 【尺寸1】 / 【尺寸2】 / 【尺寸3】 / 【重量/容量】. Use clean arrows and simple mini illustrations where helpful.
